...
namespace DotnetSdkUtilities.StringExtensions
{
    ...
    public static class StringCipherExtensions
    {
        ...
        public static string EncryptToString(this string plainText, string passPhrase)
        {
            return Convert.ToBase64String(Encrypt(plainText, passPhrase));
        }
        ...
        public static string DecryptFromString(this string cipherText, string passPhrase)
        {
            return Decrypt(Convert.FromBase64String(cipherText), passPhrase);
        }
        public static string Decrypt(this byte[] cipherText, string passPhrase)
        {
